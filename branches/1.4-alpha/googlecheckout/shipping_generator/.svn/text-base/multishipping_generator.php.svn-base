...
?>						  
							  <tr id="d_tr">
							    ...
							    <td>
							    	<input type="text" name="d_m_name[<?=$shippername;?>][]" value="<?=htmlentities($methodname);?>" size="50" id="d_m_name"/>
							    </td>
							    <td>
...
?>						  
							  <tr id="i_tr">
							    ...
							    <td>
							    	<input type="text" name="i_m_name[<?=$shippername;?>][]" size="50"	 value="<?=htmlentities($methodname);?>" id="i_m_name"/>
							    </td>
							    <td>
